<template>
  <div class="about">
    <MyTitle :title="'关于我'"></MyTitle>
    <div class="about-content">
      <p>Blessed 游戏社区，是由 Hant 开发完成的系统，致力于营造一个良好的社区环境，
        为每一个热爱游戏玩家，提供一个交流，分享的平台</p>
      <p>感谢以下社区为我完成系统提供的帮助：</p>
      <van-grid :gutter="10" square :border="false">
        <van-grid-item>
          <img src="../assets/logo.png" class="my-logo" alt="">
        </van-grid-item>
        <van-grid-item>
          <img src="../assets/vant.png" class="my-logo" alt="">
        </van-grid-item>
        <van-grid-item>
          <img src="../assets/hbuildx.png" class="my-logo" alt="">
        </van-grid-item>
        <van-grid-item>
          <img src="../assets/phpstorm.png" class="my-logo" alt="">
        </van-grid-item>
        <van-grid-item>
          <img src="../assets/bilibili.png" class="my-logo" alt="">
        </van-grid-item>
        <van-grid-item>
          <img src="../assets/nginx.png" class="my-logo" alt="">
        </van-grid-item>
        <van-grid-item>
          <img src="../assets/laravel.png" class="my-logo" alt="">
        </van-grid-item>
        <van-grid-item>
          <img src="../assets/php.png" class="my-logo" alt="">
        </van-grid-item>
        <van-grid-item>
          <img src="../assets/nodejs.png" class="my-logo" alt="">
        </van-grid-item>
        <van-grid-item>
          <img src="../assets/PSQL.png" class="my-logo" alt="">
        </van-grid-item>
        <van-grid-item>
          <svg class="index-log index-log-0" version="1.1" id="图层_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="100px" height="100px" viewBox="0 0 1024 1024" enable-background="new 0 0 1024 1024" xml:space="preserve" p-id="124"><g p-id="125"><path fill="#FF0000" d="M546.368,141.385c-5.099-5.25-4.062-13.343-2.823-26.681c1.665-17.962-33.868,8.208-55.655,25.83
            C311.533,152.947,172.314,299.94,172.314,479.458c0,187.656,152.124,339.78,339.78,339.78s339.78-152.124,339.78-339.78
            C851.878,303.371,717.929,158.569,546.368,141.385z" p-id="126"></path><path fill="#FFFFFF" d="M820.57,500.997c-2.099-44.066-11.937-84.195-29.512-120.393c-17.571-36.199-40.392-67.151-68.459-92.852
            ...
            c9.44,8.48,16.785,18.252,22.031,29.326c5.246,11.074,7.868,22.968,7.868,35.687C793.025,505.651,790.404,517.546,785.157,528.616z" p-id="127" data-spm-anchor-id="a313x.7781069.1998910419.i1"></path></g></svg>
        </van-grid-item>
      </van-grid>
      <p>
...
<style scoped>
  ...
  .my-email{
    background-color: rgba(155, 187, 1, 0.8);
    color: white;
    border-radius: .2rem;
    padding: .2rem;
    font-size: .3rem;
